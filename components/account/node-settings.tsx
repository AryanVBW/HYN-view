...
const FIELDS: {
  ...
  { key: "cloud_storage", label: "Monitoring history", hint: "Cloud keeps the latest 48 hours; the server keeps its local backup. Requires CLI 1.12+.", type: "select", group: "Unattended operation",
    choices: [{ value: "cloud", label: "Cloud + local backup" }, { value: "local", label: "Local only" }] },
  { key: "cloud_push_min", label: "Upload readings every, minutes", hint: "Default 1; local recording continues independently", type: "number", group: "Alerting schedule" },
