...
export const NODE_COLUMNS =
  "id, owner, name, hostname, os, agent_version, is_demo, revoked, created_at, last_seen_at, status, paused_until, status_reason, config, last_config_pull_at, last_heartbeat_at, telemetry_mode, last_metric_at" as const;
